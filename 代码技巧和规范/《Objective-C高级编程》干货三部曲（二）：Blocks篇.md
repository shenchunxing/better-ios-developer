...
![《Objective-C高级编程》 干货三部曲](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2017/4/17/a95ff4e9b3226cc2007e3e940ebc2cfb~tplv-t2oaga2asx-zoom-in-crop-mark:4536:0:0:0.image)
...
> 而且很容易看出来，\_\_cself 是指向\_\_main\_block\_impl\_0结构体实现的指针。 结合上句话，也就是说Block结构体就是\_\_main\_block\_impl\_0结构体。Block的值就是通过\_\_main\_block\_impl\_0构造出来的。
...
> 其中，\_Block\_object\_assign相当于retain操作，将对象赋值在对象类型的结构体成员变量中。 \_Block\_object\_dispose相当于release操作。
...
先简单说一下\_\_block的作用： \_\_block说明符用于指定将变量值设置到哪个存储区域中，也就是说，当自动变量加上\_\_block说明符之后，会改变这个自动变量的存储区域。
...
![图片来自：《Objective-C高级编程：iOS与OS X多线程和内存管理》](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2017/4/17/acb75131482a3706b5537538272a8482~tplv-t2oaga2asx-zoom-in-crop-mark:4536:0:0:0.image)
...
\_\_block可以指定任何类型的自动变量。下面来指定id类型的对象:
...
1.  [深入研究Block捕获外部变量和\_\_block实现原理](https://link.juejin.cn?target=http%3A%2F%2Fwww.jianshu.com%2Fp%2Fee9756f3d5f6 "http://www.jianshu.com/p/ee9756f3d5f6")
2.  [让我们来深入浅出block吧](https://link.juejin.cn?target=http%3A%2F%2Fwww.jianshu.com%2Fp%2Fe03292674e60 "http://www.jianshu.com/p/e03292674e60")
3.  [谈Objective-C block的实现](https://link.juejin.cn?target=http%3A%2F%2Fblog.devtang.com%2F2013%2F07%2F28%2Fa-look-inside-blocks%2F "http://blog.devtang.com/2013/07/28/a-look-inside-blocks/")